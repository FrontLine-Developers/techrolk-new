...
?>
    ...
    <title>Terms & Conditions | TechRoLK Engineering Solutions</title>
...
<body>
    ...
    <div class="container">
        ...
        <p>Please read these Terms of Use (“Terms”, “Terms of Use”) carefully before using the https://techrolk.com
            website (the “Service”) operated by TechRoLK Engineering Solutions (“us”, “we”, or “our”).</p>
        ...
        <h2 class="mt-3">Intellectual Property</h2>
        <p>The Service and its original content, features and functionality are and will remain the exclusive property
            of TechRoLK Engineering Solutions and its licensors.</p>

        <h2 class="mt-3">Links To Other Web Sites</h2>
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by
            TechRoLK Engineering Solutions.</p>
        <p>TechRoLK Engineering Solutions has no control over, and assumes no responsibility for, the content, privacy
            policies, or practices of any third party web sites or services. You further acknowledge and agree that
            TechRoLK Engineering Solutions shall not be responsible or liable, directly or indirectly, for any damage or
        ...
        <p>Your use of the Service is at your sole risk. The Service is provided on an “AS IS” and “AS AVAILABLE” basis.
            ...
            course of performance.<p>
                ...
                <p>These Terms shall be governed and construed in accordance with the laws of Sri Lanka without regard
                ...
                <p>If you have any questions about these Terms, please contact us. at techrolk@gmail.com</p>
    </div>
    @include('footer')
