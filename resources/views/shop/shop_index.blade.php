...
<title>Shoppp │ TechRoLK Engineering Solutions</title>
...
<header class="section-heading">
	<a href="all-items.html" class="btn btn-outline-primary float-right">See all</a>
...
<div class="row">
	<div class="col-md-2">
		<figure class="box item-logo">
			...
			<figcaption class="text-center border-top pt-2"></figcaption>
		</figure> <!-- item-logo.// -->
	</div> <!-- col.// -->
