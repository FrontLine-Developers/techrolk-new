...
?>
    ...
    <title>Privacy Policy | TechRoLK Engineering Solutions</title>
...
<body>
    ...
    <div class="container">
        ...
        <p>TechRoLK Engineering Solutions (“us”, “we”, or “our”) operates the TechRoLK Engineering Solutions website
            (the “Service”).</p>
        ...
        <p>We use your Personal Information for providing and improving the Service. By using the Service, you agree to
            ...
            accessible at https://techrolk.com</p>
        <h2 class="mt-3">Information Collection And Use</h2>
        ...
        <h2 class="mt-3">Google AdSense & DoubleClick Cookie</h2>
        <p>Google, as a third party vendor, uses cookies to serve ads on our Service.</p>

        <h2 class="mt-3">Service Providers</h2>
        ...
        <p>These third parties have access to your Personal Information only to perform these tasks on our behalf and
        ...
        <p>The security of your Personal Information is important to us, but remember that no method of transmission
            ...
            acceptable means to protect your Personal Information, we cannot guarantee its absolute security.<p>
                ...
                <h2 class="mt-3">Links To Other Sites</h2>
                ...
                <h2 id="contact-us">Compliance With Laws</h2>
